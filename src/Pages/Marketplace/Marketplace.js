                    ...
                    <div className="col-md-7" >
                        <div className="pricing-content pricing-border">
                            <div className="pricing-list">
                                <p>Get the NFT for <b>SGD 3000 (170042.79 Indian Rupees)<br /> from 16 July 2022.</b> </p>
                    ...
                    <div className="col-md-7">
                        <div className="pricing-content pricing-border">
                            <div className="pricing-list">
                                ...
                                <p> <i>We can guarantee nothing will be more than SGD 3000 (170042.79 Indian Rupee).
